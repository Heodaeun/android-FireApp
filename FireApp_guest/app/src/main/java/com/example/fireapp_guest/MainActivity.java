...
public class MainActivity extends AppCompatActivity implements BeaconConsumer {
    TextView r11_red, r21, r22, r23, r24;
...
//        super.onRestart();
//        Intent i = new Intent(MyBeacon., MyBeacon.class);
//        startActivity(i);
//        finish();
//    }
                ...
                if (beacons.size() > 0) {
                    for(Beacon b : beacons) {
                        ...
                        if (uuid.equals("00000101-b644-4520-8f0c-720eaf059935")) {
                            createNotification("102호 화재 발생", "초록색 빛을 따라 신속히 대피하시길 바랍니다.", 11);
                        }else if (uuid.equals("00000102-b644-4520-8f0c-720eaf059935")) {
                            createNotification("102호 가스 감지", "창문을 열어 환기시키길 바랍니다", 12);
                        }else if (uuid.equals("00000201-b644-4520-8f0c-720eaf059935")) {
                            createNotification("201호 화재 발생", "초록색 빛을 따라 신속히 대피하시길 바랍니다.", 13);
                        }else if (uuid.equals("00000202-b644-4520-8f0c-720eaf059935")) {
                            createNotification("202호 화재 발생", "초록색 빛을 따라 신속히 대피하시길 바랍니다.", 14);
                        }else if (uuid.equals("00000203-b644-4520-8f0c-720eaf059935")) {
                            createNotification("203호 화재 발생", "초록색 빛을 따라 신속히 대피하시길 바랍니다.", 15);
                        }else if (uuid.equals("00000204-b644-4520-8f0c-720eaf059935")) {
                            createNotification("204호 화재 발생", "초록색 빛을 따라 신속히 대피하시길 바랍니다.", 16);
                        }
                    }
                }
            }
...
//    }
    ...
    private void createNotification(String title, String context, int id) {
        ...
        if(id==12) {
            builder.setSmallIcon(R.drawable.blue_lights)
                    .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.fog))
